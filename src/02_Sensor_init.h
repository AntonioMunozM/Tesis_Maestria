...
void Setup_ADC1() {
   ...
   */
  adc1.setCompareChannels(ADS1115_COMP_0_GND); //comment line/change parameter to change channel
   ...
   *  ADS1115_COMP_3_GND  ->  compares 3 with GND
   */
  adc2.setCompareChannels(ADS1115_COMP_0_GND); //comment line/change parameter to change channel
   ...
   *  ADS1115_SINGLE     ->  single shot mode (default)
   */
  adc2.setMeasureMode(ADS1115_CONTINUOUS); //comment line/change parameter to change mode
